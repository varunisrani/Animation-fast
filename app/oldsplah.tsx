  ...
  useEffect(() => {
    ...
    const measureTimer = setTimeout(() => {
      if (centerButtonRef.current) {
        ...
        const purpleCircleSize = styles.purpleCircle.width;
    ...
    const timer = setTimeout(() => {
      Animated.sequence([
        ...
        Animated.spring(purpleScale, {
          ...
          damping: Platform.OS === 'android' ? 15 : 12,
          stiffness: Platform.OS === 'android' ? 50 : 40,
          mass: Platform.OS === 'android' ? 1.2 : 1
        }),
        // Fade out logo first
        ...
        Animated.parallel([
          ...
          Animated.spring(purpleTranslateY, {
            ...
            stiffness: Platform.OS === 'android' ? 50 : 40,
            mass: Platform.OS === 'android' ? 1.2 : 1,
            velocity: Platform.OS === 'android' ? 0.1 : 0.05
          }),
          ...
          Animated.sequence([
            Animated.delay(Platform.OS === 'android' ? 700 : 350),
            Animated.timing(purpleCircleOpacity, {
              toValue: 0,
              duration: Platform.OS === 'android' ? 1 : 5,
              useNativeDriver: true,
